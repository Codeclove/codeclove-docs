...
<div class="step-list">
  ...
  <div class="step-item" id="step-2-upload-and-install-via-wordpress-dashboard">
    ...
    <div class="step-title">Upload and Install via WordPress Dashboard</div>
    <ol>
      ...
      <li>Select the downloaded <code>nexora.zip</code> file and click <strong>Install Now</strong>.</li>
      <li>Once the upload completes, click <strong>Activate Plugin</strong>.</li>
    </ol>
  </div>
...
## Staging & Local Development Activations

Your license key can be activated on local development environments and staging subdomains without consuming your live site activation limit:
...
Once your license key is active, plugin updates appear automatically in your WordPress dashboard under **Dashboard > Updates** and **Plugins**.

1. When a new version is released, an update notice will display in your **Plugins** list.
2. Click **Update Now** to perform a one-click in-place update.
3. Your database tables and operational records are automatically updated during activation.
